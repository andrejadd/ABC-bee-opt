...
#		n.of.ants	- the number of ants to be used,
...
eACO <- function(min.range, max.range, e.abs, n.of.ants, n.of.dist, n.of.vars, max.value, show=FALSE) {
