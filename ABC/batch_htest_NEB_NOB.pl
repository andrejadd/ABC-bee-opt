...
my $basedir =  "/home/andrej/Desktop/latex-arbeit/final_figs/POPSIZE_HTEST_D30/";
...
foreach my $curr_fct (@fct) { 
	...
	foreach my $nob (@nobs) {
	    ...
	    open( APPCALL, "java ModelTester -fct $curr_fct -method $method -neb $neb -nob $nob -pmode 1 -runs $runs -standardlimit $standardlimit -pmode $printmode |") || die "exec failed";
