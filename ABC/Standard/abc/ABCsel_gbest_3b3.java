...
public class ABCsel_gbest_3b3 implements ModelInterface {
...
private void UpdateGBest() {
		...
		if(gC_gbest_current.size() == 0) {
			...
			for(int i = 0; i < gi_gbest; i++) {
				Solution lC_tmp = (Solution) lCa_sortedSolutions[i];
				//Solution lC_gbest_current = (Solution) gC_gbest_current.get(i);
				
				//if(lC_tmp.value != lC_gbest_current.value) {
