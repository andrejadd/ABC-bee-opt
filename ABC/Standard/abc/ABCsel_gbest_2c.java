...
public class ABCsel_gbest_2c implements ModelInterface {
	...
	public void Init(TestFunction am_fcttest, ParameterHolder aC_params) {
		...
		gi_n = (Integer) aC_params.get(GlobalParameters.NEB);// + (Integer) aC_params.get(GlobalParameters.NOB);
