...
public class ABCsel_rank_4 implements ModelInterface {
...
private double[] modifyposition(Solution aC_solution, int ai_index) {
    	...
    	/* if highest rank, decrease */
    	if(li_ownrank == gi_n) {
    		li_ownrank -= 3;
    	}
    	
		k = (li_ownrank + generator.nextInt(gi_n- li_ownrank) + 1);
		j = generator.nextInt(gi_dim);
	    
		/* get solution with this rank */
